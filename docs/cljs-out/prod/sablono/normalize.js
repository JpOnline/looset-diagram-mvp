...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__15216){
var vec__15217 = p__15216;
var _ = cljs.core.nth.call(null,vec__15217,(0),null);
var v = cljs.core.nth.call(null,vec__15217,(1),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__15220_SHARP_){
return (((p1__15220_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__15220_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__15221,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__15221;
}
});
...
var len__4789__auto___15224 = arguments.length;
var i__4790__auto___15225 = (0);
while(true){
if((i__4790__auto___15225 < len__4789__auto___15224)){
args__4795__auto__.push((arguments[i__4790__auto___15225]));

var G__15226 = (i__4790__auto___15225 + (1));
i__4790__auto___15225 = G__15226;
continue;
} else {
}
break;
...
var G__15223 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_.call(null,classes)))){
return cljs.core.assoc.call(null,G__15223,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__15223;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq15222){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15222));
}));
...
var vec__15229 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__15229,(0),null);
var names = cljs.core.nth.call(null,vec__15229,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,(function (p1__15227_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__15227_SHARP_))){
return p1__15227_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__15228_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__15228_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__15232){
var vec__15233 = p__15232;
var seq__15234 = cljs.core.seq.call(null,vec__15233);
var first__15235 = cljs.core.first.call(null,seq__15234);
var seq__15234__$1 = cljs.core.next.call(null,seq__15234);
var tag = first__15235;
var content = seq__15234__$1;
...
var vec__15236 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__15236,(0),null);
var id = cljs.core.nth.call(null,vec__15236,(1),null);
var class$ = cljs.core.nth.call(null,vec__15236,(2),null);
