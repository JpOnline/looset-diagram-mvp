...
var x15241_15242 = ctor.prototype;
(x15241_15242.onChange = (function (event){
var this$ = this;
...
(x15241_15242.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__15246) {
case "input":
var G__15247 = ((cljs.core.object_QMARK_.call(null,props))?props.type:false);
switch (G__15247) {
case "radio":
...
var len__4789__auto___15253 = arguments.length;
var i__4790__auto___15254 = (0);
while(true){
if((i__4790__auto___15254 < len__4789__auto___15253)){
args__4795__auto__.push((arguments[i__4790__auto___15254]));

var G__15255 = (i__4790__auto___15254 + (1));
i__4790__auto___15254 = G__15255;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq15250){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15251,G__15252,seq15250__$2);
}));
...
var vec__15257 = sablono.normalize.element.call(null,element);
var type = cljs.core.nth.call(null,vec__15257,(0),null);
var attrs = cljs.core.nth.call(null,vec__15257,(1),null);
var content = cljs.core.nth.call(null,vec__15257,(2),null);
