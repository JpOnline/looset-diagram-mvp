...
var map__23588 = top_item;
var map__23588__$1 = (((((!((map__23588 == null))))?(((((map__23588.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23588.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23588):map__23588);
...
}catch (e23587){var _e = e23587;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___23590 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___23590)){
var seen_errors_23591 = temp__5733__auto___23590;
if(cljs.core.truth_(seen_errors_23591.has(self))){
} else {
seen_errors_23591.add(self);

var temp__5735__auto___23592 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___23592)){
var sense_23593 = temp__5735__auto___23592;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_23593)].join(''));
} else {
}
}
} else {
