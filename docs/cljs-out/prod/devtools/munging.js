...
var o22727 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22727["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22728 = temp__5733__auto____$1;
return (o22728["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21837__auto__ = f;
return (o__21837__auto__["toString"]).call(o__21837__auto__);
} else {
return "";
}
}catch (e22729){var _ = e22729;
return "";
}});
...
try{var o__21837__auto___22731 = t;
(o__21837__auto___22731["cljs$lang$ctorPrWriter"]).call(o__21837__auto___22731,t,writer);
}catch (e22730){var __22732 = e22730;
}
...
var char_code = (function (){var o__21837__auto__ = (new String(char$));
return (o__21837__auto__["charCodeAt"]).call(o__21837__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21837__auto__ = String;
return (o__21837__auto__["fromCharCode"]).call(o__21837__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22733 = num_code;
switch (G__22733) {
case (1):
return (185);
...
var o__21837__auto__ = String;
return (o__21837__auto__["fromCharCode"]).call(o__21837__auto__,superscript_code);
});
/**
...
}catch (e22735){var _e__21844__auto__ = e22735;
return false;
}})())){
...
var vec__22736 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22736,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o22739 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22739["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22740 = temp__5733__auto____$1;
return (o22740["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22743){
var vec__22744 = p__22743;
var ns_detector = cljs.core.nth.call(null,vec__22744,(0),null);
...
var G__22750 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22751 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22750;
remaining_tokens = G__22751;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22741){
var G__22742 = cljs.core.first.call(null,seq22741);
var seq22741__$1 = cljs.core.next.call(null,seq22741);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22742,seq22741__$1);
}));
...
var vec__22755 = cljs.core.split_with.call(null,(function (p1__22754_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22754_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22755,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22755,(1),null);
...
var vec__22761 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22761,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22761,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22764 = cljs.core.rest.call(null,remaining_tokens);
var G__22765 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22764;
name_tokens = G__22765;
continue;
} else {
...
var vec__22768 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22768,(0),null);
var arity = cljs.core.nth.call(null,vec__22768,(1),null);
var vec__22771 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22771,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22771,(1),null);
var vec__22774 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22774,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22774,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22774,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22774,(3),null);
...
var vec__22780 = result;
var munged_ns = cljs.core.nth.call(null,vec__22780,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22780,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22780,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22780,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22780,(4),null);
var arity = cljs.core.nth.call(null,vec__22780,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__22784 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__22784,(0),null);
var args = cljs.core.nth.call(null,vec__22784,(1),null);
var vec__22787 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22787,(0),null);
var name = cljs.core.nth.call(null,vec__22787,(1),null);
...
var G__22790 = (arity + (1));
var G__22791 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22792){
var vec__22793 = p__22792;
var arity = cljs.core.nth.call(null,vec__22793,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22793,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22796_SHARP_){
return cljs.core.get.call(null,arities,p1__22796_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22797_SHARP_){
return cljs.core.drop.call(null,(2),p1__22797_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___22804 = arguments.length;
var i__4790__auto___22805 = (0);
while(true){
if((i__4790__auto___22805 < len__4789__auto___22804)){
args__4795__auto__.push((arguments[i__4790__auto___22805]));

var G__22806 = (i__4790__auto___22805 + (1));
i__4790__auto___22805 = G__22806;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22800){
var vec__22801 = p__22800;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22801,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22798){
var G__22799 = cljs.core.first.call(null,seq22798);
var seq22798__$1 = cljs.core.next.call(null,seq22798);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22799,seq22798__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22809__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22809__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22809__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22809__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22810 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22810,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22810,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22810,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22810,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22810,(4),null);
var arity = cljs.core.nth.call(null,vec__22810,(5),null);
...
var o__21837__auto__ = f;
return (o__21837__auto__["getBasis"]).call(o__21837__auto__);
});
/**
...
}catch (e22814){var _e__21844__auto__ = e22814;
...
var G__22815 = (obj[cljs.core.first.call(null,path)]);
var G__22816 = cljs.core.rest.call(null,path);
obj = G__22815;
path = G__22816;
continue;
} else {
...
var _STAR_ = (function (accum,p__22817){
var vec__22818 = p__22817;
var bit = cljs.core.nth.call(null,vec__22818,(0),null);
var protocol = cljs.core.nth.call(null,vec__22818,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22821){
var vec__22822 = p__22821;
var ns = cljs.core.nth.call(null,vec__22822,(0),null);
var name = cljs.core.nth.call(null,vec__22822,(1),null);
var selector = cljs.core.nth.call(null,vec__22822,(2),null);
...
var post_process = (function (p__22826){
var vec__22827 = p__22826;
var munged_name = cljs.core.nth.call(null,vec__22827,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22827,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22825_SHARP_){
return (obj[cljs.core.first.call(null,p1__22825_SHARP_)]);
}),sorted_matches);
