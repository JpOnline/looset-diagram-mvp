...
var len__4789__auto___22846 = arguments.length;
var i__4790__auto___22847 = (0);
while(true){
if((i__4790__auto___22847 < len__4789__auto___22846)){
args__4795__auto__.push((arguments[i__4790__auto___22847]));

var G__22848 = (i__4790__auto___22847 + (1));
i__4790__auto___22847 = G__22848;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22843){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22844,G__22845,seq22843__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22849_SHARP_){
return (!((cljs.core.meta.call(null,p1__22849_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__22850__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22854){var _e__21837__auto__ = e22854;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e22856){var _e__21837__auto__ = e22856;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22858 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22859 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22859);

try{var map__22860 = opts;
var map__22860__$1 = (((((!((map__22860 == null))))?(((((map__22860.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22860.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22860):map__22860);
var markup_db = cljs.core.get.call(null,map__22860__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22858);
}});
...
var temp__5733__auto___22865 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___22865)){
var managed_print_level_22866 = temp__5733__auto___22865;
var _STAR_print_level_STAR__orig_val__22863_22867 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22864_22868 = managed_print_level_22866;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22864_22868);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22862_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22862_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22863_22867);
}} else {
job_fn.call(null);
}
