...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22852){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22853,G__22854,seq22852__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22858_SHARP_){
return (!((cljs.core.meta.call(null,p1__22858_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__22859__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22863){var _e__21846__auto__ = e22863;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e22865){var _e__21846__auto__ = e22865;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22867 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22868 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22868);

try{var map__22869 = opts;
...
var markup_db = cljs.core.get.call(null,map__22869__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22867);
}});
...
var temp__5733__auto___22874 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___22874)){
var managed_print_level_22875 = temp__5733__auto___22874;
var _STAR_print_level_STAR__orig_val__22872_22876 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22873_22877 = managed_print_level_22875;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22873_22877);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22871_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22871_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22872_22876);
}} else {
job_fn.call(null);
}
