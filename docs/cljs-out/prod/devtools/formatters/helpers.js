...
var G__22825 = devtools.prefs.pref.call(null,v);
v = G__22825;
continue;
} else {
return v;
...
}catch (e22828){var _e__21837__auto__ = e22828;
return false;
}})();
...
}catch (e22832){var _e__21837__auto__ = e22832;
return false;
}})();
...
}catch (e22834){var _e__21837__auto__ = e22834;
return false;
}}
}
});
...
var vec__22836 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22836,(0),null);
var name = cljs.core.nth.call(null,vec__22836,(1),null);
...
return cljs.core.some.call(null,(function (p1__22839_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22839_SHARP_);
}),template);
});
