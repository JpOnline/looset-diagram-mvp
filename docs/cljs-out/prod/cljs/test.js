...
var G__17706 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__17706,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__17706;
}
}));
...
var len__4789__auto___17711 = arguments.length;
var i__4790__auto___17712 = (0);
while(true){
if((i__4790__auto___17712 < len__4789__auto___17711)){
args__4795__auto__.push((arguments[i__4790__auto___17712]));

var G__17713 = (i__4790__auto___17712 + (1));
i__4790__auto___17712 = G__17713;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq17708){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17709,G__17710,seq17708__$2);
}));
...
var line = cljs.core.get.call(null,map__17715__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__17715__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__17714_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__17714_SHARP_));
...
var temp__5735__auto___17717 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___17717)){
var message_17718 = temp__5735__auto___17717;
cljs.core.println.call(null,message_17718);
} else {
}
...
var temp__5735__auto___17719 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___17719)){
var message_17720 = temp__5735__auto___17719;
cljs.core.println.call(null,message_17720);
} else {
}
...
var output_dir__$1 = (function (){var G__17721 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__17721,"/"].join('');
} else {
return G__17721;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__17723 = exception.stack;
var G__17723__$1 = (((G__17723 == null))?null:clojure.string.split_lines.call(null,G__17723));
var G__17723__$2 = (((G__17723__$1 == null))?null:cljs.core.get.call(null,G__17723__$1,depth));
if((G__17723__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__17723__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__17724 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__17724,(0),null);
var column = cljs.core.nth.call(null,vec__17724,(1),null);
var vec__17727 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__17727,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__17727,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__17727,(2),null);
...
var m__$1 = (function (){var G__17730 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__17734 = (function (){var G__17733 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__17733);
} else {
return G__17733;
}
})();
...
return cljs.core.vary_meta.call(null,G__17735,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__17739 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__17739,(0),null);
var types = vec__17739;
...
return cljs.core.map.call(null,(function (p__17742){
var vec__17743 = p__17742;
var ns = cljs.core.nth.call(null,vec__17743,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__17743,(1),null);
return (function (){
...
var G__17746 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__17747 = cljs.core.seq.call(null,vars__$1);
var chunk__17748 = null;
var count__17749 = (0);
var i__17750 = (0);
while(true){
if((i__17750 < count__17749)){
var v = cljs.core._nth.call(null,chunk__17748,i__17750);
var temp__5735__auto___17752 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___17752)){
var t_17753 = temp__5735__auto___17752;
each_fixture_fn.call(null,((function (seq__17747,chunk__17748,count__17749,i__17750,t_17753,temp__5735__auto___17752,v,each_fixture_fn,G__17746,G__17746__$1,env,once_fixtures,each_fixtures,vec__17743,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17753)));
});})(seq__17747,chunk__17748,count__17749,i__17750,t_17753,temp__5735__auto___17752,v,each_fixture_fn,G__17746,G__17746__$1,env,once_fixtures,each_fixtures,vec__17743,ns,vars__$1))
);
} else {
}


var G__17754 = seq__17747;
var G__17755 = chunk__17748;
var G__17756 = count__17749;
var G__17757 = (i__17750 + (1));
seq__17747 = G__17754;
chunk__17748 = G__17755;
count__17749 = G__17756;
i__17750 = G__17757;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__17747);
if(temp__5735__auto__){
var seq__17747__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__17747__$1)){
var c__4609__auto__ = cljs.core.chunk_first.call(null,seq__17747__$1);
var G__17758 = cljs.core.chunk_rest.call(null,seq__17747__$1);
var G__17759 = c__4609__auto__;
var G__17760 = cljs.core.count.call(null,c__4609__auto__);
var G__17761 = (0);
seq__17747 = G__17758;
chunk__17748 = G__17759;
count__17749 = G__17760;
i__17750 = G__17761;
continue;
} else {
var v = cljs.core.first.call(null,seq__17747__$1);
var temp__5735__auto___17762__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___17762__$1)){
var t_17763 = temp__5735__auto___17762__$1;
each_fixture_fn.call(null,((function (seq__17747,chunk__17748,count__17749,i__17750,t_17763,temp__5735__auto___17762__$1,v,seq__17747__$1,temp__5735__auto__,each_fixture_fn,G__17746,G__17746__$1,env,once_fixtures,each_fixtures,vec__17743,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17763)));
});})(seq__17747,chunk__17748,count__17749,i__17750,t_17763,temp__5735__auto___17762__$1,v,seq__17747__$1,temp__5735__auto__,each_fixture_fn,G__17746,G__17746__$1,env,once_fixtures,each_fixtures,vec__17743,ns,vars__$1))
);
} else {
}


var G__17764 = cljs.core.next.call(null,seq__17747__$1);
var G__17765 = null;
var G__17766 = (0);
var G__17767 = (0);
seq__17747 = G__17764;
chunk__17748 = G__17765;
count__17749 = G__17766;
i__17750 = G__17767;
continue;
}
} else {
