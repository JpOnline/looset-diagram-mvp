...
return [(function (){var pred__9191 = cljs.core.instance_QMARK_;
var expr__9192 = reactive_val;
if(cljs.core.truth_(pred__9191.call(null,reagent.ratom.RAtom,expr__9192))){
return "ra";
} else {
if(cljs.core.truth_(pred__9191.call(null,reagent.ratom.RCursor,expr__9192))){
return "rc";
} else {
if(cljs.core.truth_(pred__9191.call(null,reagent.ratom.Reaction,expr__9192))){
return "rx";
} else {
if(cljs.core.truth_(pred__9191.call(null,reagent.ratom.Track,expr__9192))){
return "tr";
} else {
return "other";
}
